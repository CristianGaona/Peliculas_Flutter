...
class PeliculasProvider {
  ...
  Future<List<Actor>> getCast(String peliId) async {
    ...
    final resp = await http.get(
        url); //await espera la respuesta, http consume la info del endpoint
    final decodeData =
        jsonDecode(resp.body); // Toma el Boddy del json y lo transfoma a map

    final cast = new Cast.fromJsonList(
        decodeData['cast']); // se envia el mapa en la propiedad de cast
